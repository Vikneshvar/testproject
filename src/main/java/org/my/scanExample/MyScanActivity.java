...
public class MyScanActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null && data.hasExtra(CardIOActivity.EXTRA_SCAN_RESULT)) {
            ...
            Log.e("Card Number: ", "" + scanResult.getRedactedCardNumber() + "\n");
            Log.e("Card Type: ", "" + scanResult.getCardType() + "\n");
            Log.e("Formatted Card Number: ", "" + scanResult.getFormattedCardNumber() + "\n");
            Log.e("Last 4 digit Card Number: ", "" + scanResult.getLastFourDigitsOfCardNumber() + "\n");
